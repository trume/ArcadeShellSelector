...
Botón Launch App: lanza el Launcher directamente (verificando que no esté ya en ejecución) y cierra el Configurator.
Icono de la app: usa el mismo icono (app.ico) tanto en el exe como en la barra de título.
